...
const fieldVariants = cva('group/field flex w-full gap-3 data-[invalid=true]:text-[#ef4343]', {
  variants: {
    orientation: {
  ...
  return (
    <Label
      ...
      className={cn(
        ...
        'has-data-[state=checked]:bg-[#0076b6]/5 has-data-[state=checked]:border-primary dark:has-data-[state=checked]:bg-[#0076b6]/10',
        className
      )}
      {...props}
    />
  ...
  return (
    <p
      ...
      className={cn(
        ...
        '[&>a:hover]:text-[#0076b6] [&>a]:underline [&>a]:underline-offset-4',
        className
      )}
      {...props}
    />
...
function FieldSeparator({
  ...
  return (
    <div data-slot="field-separator" data-content={!!children} className={cn('relative -my-2 h-5 text-sm group-data-[variant=outline]/field-group:-mb-2', className)} {...props}>
      ...
      {children && (
        <span className="bg-background text-gray-500relative mx-auto block w-fit px-2" data-slot="field-separator-content">
          {children}
        </span>
      )}
    </div>
...
function FieldError({
  ...
  return (
    <div role="alert" data-slot="field-error" className={cn('text-[#ef4343] text-sm font-normal', className)} {...props}>
      {content}
    </div>
  );
}
