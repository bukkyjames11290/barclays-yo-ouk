...
const TransactionItem = ({ merchant, category, date, amount, status, onClick }: TransactionItemProps) => {
  ...
  return (
    <div onClick={onClick} className="flex gap-3 py-3 border-b border-gray-200/50 last:border-0 hover:bg-[#0076b6]/30 -mx-2 px-2 rounded-lg transition-colors cursor-pointer">
