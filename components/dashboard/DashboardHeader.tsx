...
export default function DashboardHeader() {
  ...
  return (
    <header className="pb-6 animate-fade-up">
      <div className="flex p-5 py-2 items-center border-b border-b-[#0076b6] bg-white justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <span className="absolute top-1.5 right-1.5 w-2.5 h-2.5 bg-[#0076b6] rounded-full border-2 border-card" />
          </Link> */}
