      ...
      <div className="flex flex-col">
        ...
        <div className="px-[16px] mb-4">
          {user.bank_details.isLedger ? (
            <div className="border flex flex-col gap-6 bg-[#0076b6] text-white p-4 rounded-lg">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link href="/dashboard/transfer" className="p-[5px_20px] rounded-full bg-white text-[#0076b6] text-[14px]">
                  Send money
                </Link>
              </div>
            </div>
          ) : user.bank_details.isChecking ? (
            <div className="flex flex-col justify-between gap-4 bg-[#0076b6] text-white p-4 rounded-lg">
              ...
              <div className="flex justify-between gap-6">
                ...
                <div className="flex flex-col gap-5">
                  <Link href="/dashboard/transfer" className="p-[5px_20px] flex rounded-full bg-white text-[#0076b6] text-[14px]">
                    Send money
                  </Link>
                </div>
              </div>
        ...
        <div className="p-[16px] hidden border py-8">
          <div className="flex items-center justify-center gap-3">
            <Link href="/dashboard/cards" className="border flex items-center gap-1 p-4 py-2 text-[13px] max-w-max bg-white text-[#0076b6] rounded-full">
              <CardIcon className="w-5 h-5" /> <span>Cards</span>
            </Link>
            <Link href="/dashboard/bill-payment" className="border flex items-center gap-1 p-4 py-2 text-[13px] max-w-max bg-white text-[#0076b6] rounded-full">
        ...
        <div className="border flex flex-col gap-4 p-6 px-4">
          <div className="border flex flex-col gap-4 bg-[#161b2f] rounded-2xl overflow-hidden">
            <Image src="https://i.imgur.com/MZMQOPJ.jpeg" width={5000} height={5000} className="" alt="sjsusbnnsn" />

            <div className="text-white p-3 px-7 pb-7">
              Get a rewarding cashback* bonus on eligible purchases
              <br />
              <br />
